...
public class C01_Xpath {
    public static void main(String[] args) throws InterruptedException {
        ...
        /*
        şuana kadar ogrendiginmiz locater lar yani elemenletin saklandıgı yerler html nin kendisine baglı olan
        locaterlar idi.
        xpatg ve cssSelector sadece bir attribute veya tag e baglı olmadan her web elementi locate etmemizi
        saglar.
        her hmtl nin
        -tag ı
        -attribute u
        -bu attribute lerin degeri yani attribute value leri vardır.

        xpath ve cssSelector bu uc maddenin kombinasyonu ile oluşur.
        //tagismi[@attributeIsmi="bu attrıbute un value si"]
