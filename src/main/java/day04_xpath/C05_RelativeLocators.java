...
public class C05_RelativeLocators {
    public static void main(String[] args) {
        ...
        WebElement boston1=driver.findElement(RelativeLocator.with(By.tagName("p")).toRightOf(london).toLeftOf(berlin));
        System.out.println(boston1.getAttribute("id"));//pid6_price

        //toronto nun altı dersek çıkar mı?

        WebElement toronto=driver.findElement(By.id("pid2_thumb"));

        WebElement boston2=driver.findElement(RelativeLocator.with(By.className("ui-li-aside")).below(toronto));
        System.out.println(boston2.getAttribute("id"));//pid6_price

        //mounti nin ustunde amsterdam yakınında

        WebElement mountie=driver.findElement(By.id("pid10_thumb"));
        WebElement amsterdam=driver.findElement(By.id("pid9_thumb"));

        WebElement boston3=driver.findElement(RelativeLocator.with(By.tagName("p")).above(mountie));
